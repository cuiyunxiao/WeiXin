...
const confirmentity = require('../../../config.js').confirmentity;
var app = getApp()
Page({
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        that.setData({
          ...
          entityReqs: res.data.data.entityReqs
        })
        console.log(that.data.orderlist.requireStatus)
